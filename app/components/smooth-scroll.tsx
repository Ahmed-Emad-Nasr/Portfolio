...
// ---------------------------------------------------------------------------
// Scroll Progress Bar
// PERF: Skip setState when progress delta < 0.3% — avoids re-renders mid-scroll
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Lenis + GSAP ScrollTrigger sync + Keyboard handling (Restored for max smoothness)
// ---------------------------------------------------------------------------
type SyncProps = {
...
export function SmoothScroll({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    // Load heavy modules in parallel once
    void Promise.all([
      import("lenis/react"),
      import("gsap"),
