            ...
            {TECHNICAL_SKILLS.map((skill, index) => (
              <div key={index} className={styles["progress-item"]}>
                ...
                <div className={styles["progress-bg"]}>
                  <motion.div className={styles["progress-fill"]} initial={{ width: 0 }} animate={techInView ? { width: `${skill.percentage}%` } : { width: 0 }} transition={{ duration: 0.8, ease: SLIDE_EASE, delay: index * 0.1 }} />
                </div>
              </div>
            ))}
          </div>
          ...
          <div className={styles["progress-grid"]}>
            {PROFESSIONAL_SKILLS.map((skill, index) => (
              <div key={index} className={styles["progress-item"]}>
                ...
                <div className={styles["progress-bg"]}>
                  <motion.div className={styles["progress-fill"]} initial={{ width: 0 }} animate={profInView ? { width: `${skill.percentage}%` } : { width: 0 }} transition={{ duration: 0.8, ease: SLIDE_EASE, delay: index * 0.1 }} />
                </div>
              </div>
            ))}
          </div>
