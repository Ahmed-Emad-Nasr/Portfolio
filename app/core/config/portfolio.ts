...
export const knowledgeEducationItems = [
  {
    ...
    desc: "Supported instructors during DEPI and DECI summer sessions, coordinating attendance and activities for 150+ students.",
    isRight: false,
  ...
  },
  {
    ...
    desc: "Triaged 150+ simulated SOC alerts using NIST 800-61 workflows on THM and LetsDefend; maintained 95%+ correct classification rate. • Designed and implemented a detection lab using Wazuh, Suricata, VirusTotal, and YARA rules, increasing detection coverage by 12%.",
    isRight: true,
  ...
  },
  {
    ...
    subTag: "Digital Egypt Pioneers Initiative (DEPI)",
    subTagHyperlink: "https://www.depi.gov.eg/",
    desc: "Applied ISO/IEC 27001 and ISMS principles, including risk assessment and security controls. • Built an ELK-based centralized logging environment across 5+ endpoints, enabling security alert detection in under 60 seconds.",
    isRight: false,
  ...
  },
  {
    ...
    desc: "Delivered 35+ cybersecurity sessions to 120+ learners, earning 1st place among 200 instructors and the Best Technical Instructor Award.",
    isRight: true,
  ...
  },
  {
    ...
    desc: "Exploited 15+ vulnerabilities in CTF and lab environments; executed privilege escalation and lateral movement mapped to MITRE ATT&CK. • Completed 100% of INE eJPT labs covering enumeration, exploitation, and pivoting; passed certification exam with 90% on first attempt.",
    isRight: false,
