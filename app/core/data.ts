...
export const caseEvidenceLibrary = [
  ...
  {
    id: "set-tool-writeup-pdf",
    title: "SET Tool Social Engineering Write-up",
    description: "Hands-on Social Engineering Toolkit scenario covering payload setup, delivery flow, and defensive monitoring observations.",
    platform: "Security Simulation",
    type: "PDF Report",
    category: "Social Engineering",
    difficulty: "Medium",
    href: "Assets/Cases/SET TOOL Writeup/AhmedEmad_SET.pdf",
    tags: ["SET", "Social Engineering", "Phishing Simulation"],
    tools: ["SET", "Kali Linux", "Network Monitoring"],
    skillsGained: ["Social Engineering Analysis", "Attack Simulation"],
    readTime: 14,
    date: "2025-08-10",
  },
  {
    id: "set-tool-writeup-docx",
    title: "SET Tool Write-up (DOCX)",
    description: "Editable documentation version of the SET Tool simulation write-up.",
    platform: "Security Simulation",
    type: "DOCX Write-up",
    category: "Social Engineering",
    difficulty: "Medium",
    href: "Assets/Cases/SET TOOL Writeup/AhmedEmad_SET.docx",
    tags: ["SET", "Documentation", "Simulation"],
    tools: ["SET"],
    skillsGained: ["Reporting", "Attack Documentation"],
    readTime: 8,
    date: "2025-08-10",
  },
] as const;
