...
export const caseEvidenceLibrary = [
            ...
            },
      {
        ...
        date: "2026-04-18",
        screenshots: [
          ...Array.from({ length: 25 }, (_, i) => `Assets/Cases/Hidden Backdoor/Screenshot (${50 + i}).webp`),
        ],
    ...
    // WannaCry always first (featured)
    {
      ...
      screenshots: [
        ...
        // Screenshot (343).webp to Screenshot (366).webp
    ...
    },
{
    ...
    date: "2026-04-28",
    screenshots: [
      "Assets/Cases/Data Exfiltiration Investigation/1.webp",
    ],
    ...
    date: "2026-04-24",
    screenshots: [
      "Assets/Cases/AWS-GaurdDuty/1.webp", 
    ],
  ...
  },
{
  ...
  },
 {
    ...
    screenshots: [
      "Assets/Cases/Amazon S3 and Amazon Athena/16.webp", 
    ],
  ...
  },
  {
    ...
    date: "2026-04-18",
    screenshots: [
      ...Array.from({ length: 18 }, (_, i) => `Assets/Cases/LockBit/Screenshot (${85 + i}).webp`),
    ],
    ...
    ,
    {
      ...
      date: "2026-04-19",
      screenshots: [
        ...Array.from({ length: 13 }, (_, i) => `Assets/Cases/ImageStegano/Screenshot (${104 + i + (i >= 3 ? 1 : 0)}).webp`),
      ],
