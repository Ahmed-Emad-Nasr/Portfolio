...
export const staticProjectFallback = [
  ...
  {
    id: 90004,
    name: "SET TOOL Social Engineering Writeup",
    description: "Hands-on Social Engineering Toolkit scenario: payload setup, delivery, and defensive monitoring.",
    language: "PDF",
    html_url: null,
    homepage: null,
    stargazers_count: 0,
    ...
    topics: ["set", "social-engineering", "phishing", "simulation"],
    default_branch: "main",
    watchers_count: 0,
    license: null,
    pdf: "Assets/Cases/SET TOOL Writeup/AhmedEmad_SET.pdf",
    image: "/Assets/art-gallery/logo/logo.png",
  },
  {
    id: 90005,
